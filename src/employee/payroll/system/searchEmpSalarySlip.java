...
PreparedStatement pst=null;
     ...
     */
    public searchEmpSalarySlip() throws SQLException {
        initComponents();
...
//          
          String sq ="select * from Allowance where emp_id = '"+value1+"'";
            ...
            pst=Database.getConnection().prepareStatement(sq);
       rs=pst.executeQuery();
       rs.first();
           ...
           myDocument.add(new Paragraph("Overtime: "+rs.getString(4)+" Hours",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
           ...
           myDocument.add(new Paragraph("Total Earnings: "+rs.getString(10),FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.PLAIN)));
